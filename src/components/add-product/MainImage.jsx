...
const MainImage = ({ id }) => {
  ...
  return (
    <div
      className={`w-11/12 mx-auto flex flex-col py-2 px-4 my-3 shadow-[0px_0px_4.45864px_rgba(0,0,0,0.25)] ${isClicked ? "h-auto" : "h-10"
        } overflow-hidden`}
    >
      <div className="flex justify-between items-center text-xs">
        <p className="pt-1">Add Product Images</p>
        <div
          onClick={() => setIsClicked((prevalue) => !prevalue)}
          className={`w-4 h-4 text-gray-700 ${isClicked ? "rotate-90" : ""}`}
        >
      ...
      <div className="mt-4 gap-4 ">
        <form onSubmit={(e) => handleSubmit(e, id, accessToken)} className="">
          <div className="grid grid-cols-4 grid-flow-row gap-4 px-8 py-6">
            <div className="relative">
              <input
                ...
                className="border bg-[#e2eced] border-gray-400 h-6 w-32 rounded-md px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              />
          ...
          <div className="flex justify-end max-w-5xl  mx-10">
            {" "}
            <button
